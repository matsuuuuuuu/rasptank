...
class ColorTracking(Node):
    ...
    #function called when recieve "/grub" request    
    def grub_callback(self, request, response):
        ...
        while count<7:
            ...
            #if don't exist object, robot turn right 
            msg.angular.z = -0.3
            self.publisher_.publish(msg)
            time.sleep(3.0)
            msg.angular.z = 0.0  
    ...
    #function of calculate outline using color(hsv)
